    ...
    <div class="header">
      <div class="search">
        ...
        <div class="abilityBtn">
          ...
          <el-button type="danger" @click="getMoreNewChapter" :disabled="newChapterBtn" size="medium" style="margin: 0 5px;">一键映射剧集</el-button>
          <el-button type="danger" @click="moreDelete" size="medium" style="margin: 0 5px;"  >批量删除</el-button>
          <el-button type="danger" @click="moreModify" size="medium" style="margin: 0 5px;" >批量修改分类</el-button>
        </div>
...
export default {
  ...
  methods: {
    ...
    async getList(){
      ...
      let res = await this.$API['video'].getList({page,pageSize,name})
      if(res.code == 200){
    ...
    async importExcChapter(file){
      ...
      try {
        ...
        for (let i = 0; i < this.listData.length; i++) {
          ...
          this.logform.data = `第${index+1}视频章节导入完毕\n`+this.logform.data
        }
      } catch (error) {
