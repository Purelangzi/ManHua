      ...
      <div class="editContent">
        <div class="detail">
          ...
          <div class="dataRight">
            ...
            <div class="handler">
              <el-button type="success" round style="margin-right: 30px;" @click="saveDetail">保存视频</el-button>
      ...
      <div class="chapterContainer">
        <el-form ref="chapterForm" :model="chapterForm" :rules="chapterRules" label-width="80px" :inline="true" class="chapterForm">
          <el-form-item label="剧集名称" prop="title">
            <el-input v-model="chapterForm.title" placeholder="请输入剧集名称" />
          </el-form-item>
          ...
          <div class="saveAndImport">
            <el-button type="primary" style="margin-right: 15px;" size="medium" @click="onSaveChapter">保存视频</el-button>
            <el-button type="primary" :disabled="newChapterBtn" style="margin-right: 15px;" size="medium" @click="getMoreNewChapter">一键获取最新剧集</el-button>
          </div>
        </el-form>
        <div class="log">
          <span>执行日志</span>
    ...
    async getMoreNewChapter() {
      ...
      if (res.code === 200) {
        ...
        if (!chapterLength) {
          ...
          return this.$message.warning('数据为空，无最新剧集')
        }
        this.logData = `开始上传剧集...`
