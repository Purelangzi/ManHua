<template>
  <div>
    ...
    <categoryTable ref="categoryTable" :request-params="requestParams" :category-name="categoryName" @sendRowData="acceptRowData" />
    <categoryDialog ref="categoryDialog" :category-name="categoryName" :category-data="categoryData" @onLoadTable="onLoadTable" />
  </div>
</template>
<script>
